...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public bool useKeyboardRotationZAxis = true;
        public KeyCode rotateUpKey = KeyCode.V;
        public KeyCode rotateDownKey = KeyCode.C;
        private int rotateZAngle = 45;
        ...
        private int RotationDirectionZAxis
        {
            get
            {
                ...
                {
                    if (rotateZAngle ==45 && Input.GetKeyDown(KeyCode.V))
                    {
                        return -45;
                    }
                    else if (rotateZAngle ==90 && Input.GetKeyDown(KeyCode.V))
                    {
                        return -45;
                    }
                    return 0;
                ...
                {
                    if (rotateZAngle ==45 && Input.GetKeyDown(KeyCode.C))
                    {
                        return 45;
                    }
                    else if (rotateZAngle == 0 && Input.GetKeyDown(KeyCode.C))
                    {
                        return 45;
                    }
                    return 0;
        ...
        private void Rotation()
        {
            ...
            if (useKeyboardRotationZAxis)
            {
                rotateZAngle += RotationDirectionZAxis;
                m_Transform.localEulerAngles = new Vector3(rotateZAngle, m_Transform.localEulerAngles.y, m_Transform.localEulerAngles.z);
            }
                
            //transform.Rotate(Vector3.right, RotationDirectionZAxis * Time.deltaTime * rotationSped, Space.World);
